...
const scaleX = useTransform(scrollYProgress, [0, 0.2], [1.2, isMobile ? 1 : 1.5]);
const scaleY = useTransform(scrollYProgress, [0, 0.2], [0.6, isMobile ? 1 : 1.5]);
const translate = useTransform(scrollYProgress, [0, 0.8], [0, 1000]);
const rotate = useTransform(scrollYProgress, [0.05, 0.1, 0.2], [-28, -28, 0]);
...
const textOpacity = useTransform(scrollYProgress, [0, 0.1], [1, 0]);
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:py-5 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <Image
          src='/images/Screenshot from 2024-10-13 17-53-35.png'
          alt="aceternity logo"
          fill
